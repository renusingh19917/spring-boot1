...
//	{
//	empList.add(new Employee(101, "Renu", "It"));
//	empList.add(new Employee(102, "Adi", "IT"));
//	empList.add(new Employee(103, "Sanchita", "IT"));
//	empList.add(new Employee(104, "Veenu", "IT"));
//	empList.add(new Employee(105, "Arpit", "IT"));
//	}
//	
//	public List<Employee> getAllEmployees() {
//		LOG.debug("serviceGetAllEmps");
